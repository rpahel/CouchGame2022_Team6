...
public class LevelGenerator2 : MonoBehaviour
{
    ...
    //========================================================
    [Header("Image de r�f�rence.")] [SerializeField]
    ...
    //========================================================
    [Header("Cubes � utiliser.")] [SerializeField]
    private GameObject cubeEdible;
    ...
    [SerializeField]
    private Ease smoothType;

    //========================================================
    [Header("Dur�es")] [SerializeField, Range(0.1f, 2f)]
    private float attenteAvantAnim;
    ...
    public Transform[,] CubesArray
    {
        get => cubesArray;
        private set => cubesArray = value;
    }
                ...
                else if (pixColor == Color.blue)
                {
                    ...
                    if (n >= 4)
                    {
                        throw new System.Exception(
                            "Plus de pixel bleu dans l'image de référence que le max de spawns autorisés (4).");
                    }
